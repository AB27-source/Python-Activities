...
java_set = set(javaScriptArray);
print("Printing JavaScript Array as a Python set: %s\n" %java_set)
...
print("\nQuestion #6:")
favorite_movie = "Spider-Man (2002)"    
...
if favorite_movie == "Spider-Man (2002)":
...
for i in movie_list:
    if i == "blueberries":
        print("%s is a fruit and not a movie" %i)
    elif i == "Toyota":
        print ("%s is a car and not a movie" %i)
    else:
        print(i)
